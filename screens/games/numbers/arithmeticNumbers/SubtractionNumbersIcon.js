...
class SubtractionNumbersIcon extends React.Component {
  ...
  select() {
    this.props.navigation.navigate('Subtraction');
  }
...
export default withNavigationFocus(SubtractionNumbersIcon);
